...
have hABE : ¬ collinear A B E,
{
  ...
  rw show m = line_through A B, by apply incidence hAB hAm hBm at hEm,
  exact hEm,
},
have hACE : ¬ collinear A C E,
{
  rw collinear_iff_on_line_through hAC,
  rw show m = line_through A C, by apply incidence hAC hAm hCm at hEm,
  exact hEm,
},
have hBCE : ¬ collinear B C E,
{
  rw collinear_iff_on_line_through hBC,
  rw show m = line_through B C, by apply incidence hBC hBm hCm at hEm,
  exact hEm,
},
